...
//
// libtabnasjson5 is the json5 format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/json5/go"
	host "github.com/tabnas/jsonic/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasjson5"
	formatName      = "json5"
	valueOut        = true
)
...
// newParser builds one engine with the json5 grammar installed
...
func newParser() (parseFn, error) {
	j := host.Make(); if err := j.UseDefaults(plug.Json5, plug.Defaults()); err != nil { return nil, err }; return j.Parse, nil
}
...
// parseWith answers whether src is in the json5 language — and,
