...
// Package main builds the C-ABI shared library: libtabnasjson5.
//
// tabnas-clib-template: v1 (stamped by admin tasks/adopt-clib.sh;
// edit the template and re-stamp, not this file).
//
//	go build -buildmode=c-shared -o libtabnasjson5.so ./clib
//
// json5 TEXT IN, VERDICT (AND VALUE) OUT. This is one of the
...
// tabnas_grammar builds a json5 parser and returns a handle to it.
...
// tabnas_parse checks one input against the json5 grammar.
//
//export tabnas_parse
